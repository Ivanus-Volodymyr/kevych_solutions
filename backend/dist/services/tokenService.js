...
class TokenService {
    ...
    generateActionToken(payload) {
        return jsonwebtoken_1.default.sign(payload, configEnv_1.configEnv.secret_action_key, { expiresIn: configEnv_1.configEnv.expires_in_action });
    }
    ...
    verifyToken(token, tokenType = 'access') {
        ...
        if (tokenType === 'action') {
            secretWord = configEnv_1.configEnv.secret_action_key;
        }
